...
val md_theme_dark_onPrimaryContainer = Color(0xFF4D3C77)
val md_theme_dark_secondary = Color(0xFFE9B824)
val md_theme_dark_background = Color(0xFFFFFBFF)
val md_theme_dark_surface = Color.Black
val md_theme_dark_outline = Color(0xFF4D3C77)
val md_theme_dark_outlineVariant = Color(0xFF4D3C77)
val md_theme_dark_tertiary = Color(0xFF219C90)